...
export default function TransportCommunicatePage() {
    return (
        <div>
            <BannerContainer
                ...
                InnerPageTitle="BUS TOUR / GROUP PAGE NEAR YOSEMITE SOUTHGATE AND SUITES"
            />
            ...
            <div className="py-3 text-center">
              {/* <Link to="/news-inner-page">
                <button type="button" class="btn button_bg px-5">
                 BOOKING FORM
                </button>
              </Link> */}
            </div>
