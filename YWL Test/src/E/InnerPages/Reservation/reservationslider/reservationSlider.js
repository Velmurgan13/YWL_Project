...
// import { reservationPackageSlider } from "../../../../Data/reservationPackageData";
...
import BannerImage from "../../../Yosemitewestgate/assets/images/innerpages/reservationdesktop.jpg";
import BannerImage1 from "../../../Yosemitewestgate/assets/images/innerpages/reservationmobile.jpg";
import RoomBed from "../../../Yosemitewestgate/assets/images/innerpages/king_bed.jpg";
...
const ReservationSlider = (props, data) => {
  ...
  //   if (show) {
  //     document.getElementById("showRoomType" + key).style.display = "block";
  //     setShow(false);
  //   } else {
  //     document.getElementById("showRoomType" + key).style.display = "none";
  //     setShow(true);
  //   }
  // };
  // *********************************************************************
      ...
      <div className="mx-auto my-3 cust-width p-0 content-height">
        ...
        <div className="pt-3">
          <span className="sort_bar my-3">
            Step 2: Review Your Total Price and Continue by Clicking Book It Now
          </span>
